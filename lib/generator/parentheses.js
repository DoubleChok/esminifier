var ParathesesMap = {
    "CallExpression":{"FunctionExpression":true,"ConditionalExpression":true,"SequenceExpression":true, "LogicalExpression":true},
    "MemberExpression":{"FunctionExpression":true,"ConditionalExpression":true,"SequenceExpression":true,"LogicalExpression":true,"BinaryExpression":true,"NewExpression":true,"UpdateExpression":true,"AssignmentExpression":true,"Literal":true},
    ...
    "NewExpression:callee":{"LogicalExpression":true,"ConditionalExpression":true,"SequenceExpression":true,"CallExpression":true},
    ...
    "VariableDeclarator":{"SequenceExpression":true}
};
...
CustomHandling["MemberExpression"] = function(parent,ast){
    if (parent.computed && parent.property === ast ){
        return false;
    } else if (ast.type === "Literal" && (ast.value instanceof RegExp || typeof ast.value === "string") ){
